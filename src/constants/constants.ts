...
export const TONE_PROMPTS = {
  ...
  [Tone.Developer]: "Tu es un développeur senior qui explique des concepts complexes à un junior. Reformule le texte juridique suivant en utilisant des analogies et du jargon du monde du développement logiciel (API, open source, licences, dette technique, bugs, features, git, etc.). L'explication doit être à la fois technique, précise et un peu humoristique.",
